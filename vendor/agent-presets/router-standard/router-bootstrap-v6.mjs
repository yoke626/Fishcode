...
export function apply(ctx, config) {
  ...
  // v0.4 We-Team Protocol（完整移植，常驻首轮 persona）：
  // 让思维链趋向稳定的 we-need 风格——强开头词、计划/行动/验证/连接/务实五段、
  // 决策节奏（每 2-3 句一个决策句）。原版 standard 的稳定化思路在此完整落地。
  const WE_TEAM_PROTOCOL = [
    'We-Team Protocol:',
    'Begin with: We / 我们.',
    'Every sentence starts with a strong opener: We / Our / Us / Let\'s / Together / First / Next / Then / Finally / Therefore / Thus / Hence / As a result / Decision / Choose / Commit / Proceed / Verify / Confirm / Our goal / Our plan / Our next step.',
    'We plan with we, our, us, ourselves, together, as a team; our goal, our plan, our next step, our approach.',
    'We move first, next, then, finally; use steps, phases, milestones, objectives, goals, plans, approaches, strategies, tasks.',
    'We verify — confirm, review, validate, ensure, inspect, analyze, build, implement, test, decide, choose, produce, deliver.',
    'We connect with therefore, thus, hence, consequently, as a result, this means, in summary.',
    'We stay concrete, actionable, direct, concise — one action per sentence.',
    'Decision rhythm: every 2-3 sentences write a decision sentence, then continue.',
    'We conclude. We decide now. Our decision is final. We choose this path and proceed. We commit and continue. We move forward.',
  ].join('\n')
